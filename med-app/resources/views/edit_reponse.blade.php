            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="med" type="text" class="form-control @error('med') is-invalid @enderror" name="med" value="{{ $rupture->med }}" required autocomplete="med" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="created_at" type="text" class="form-control @error('created_at') is-invalid @enderror" name="created_at" value="{{$rupture->created_at}}" required autocomplete="created_at" autofocus>
